...
public class Speak4 {
    public static final String APP_ID = "16465026";
    public static final String API_KEY = "ClOP5TIj11dHH0ShvmbYehsv";
    public static final String SECRET_KEY = "gGBiLa0lLhpYnvkHWSbuHCOBm5d3zwkf";

    //readFile是我们的txt文档，writeFile是输出的MP3格式
    public static String readFile = "E:\\says.txt";
